...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [language, setLanguageState] = useState<Language>(() => {
    ...
    // 2. Second choice: Auto-detect based on region/browser locale!
    try {
      ...
      for (const locale of locales) {
        ...
        if (cleanLocale.startsWith("ru") || cleanLocale.startsWith("be") || cleanLocale.startsWith("uk") || cleanLocale.startsWith("kk")) {
          return "RU";
        }
      }
    } catch (e) {
